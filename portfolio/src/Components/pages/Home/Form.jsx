  ...
  return (
    < div className="container mx-auto p-4 md:p-6 lg:p-8 flex flex-wrap justify-center items-center">
      ...
      <h1 className=' text-5xl font-bold' >
        ...
        <img src="./images/stand.png" alt="Project Image" className=" mb-6 ml-6" />
      </div>
...
<input type="text" id="name" placeholder="Name" className="p-2 mb-2  rounded-md w-48 bg-[#393E4680] text-[#EEEEEE80]" style={{ marginRight: '10px' }} />
</div>
<div className="w-1/2 p-2">
<label className="text-sm mb-2" htmlFor="email">Your Email:</label>
<input type="email" id="email" placeholder="Email" className="p-2 mb-2   rounded-md w-48 bg-[#393E4680] text-[#EEEEEE80]" />
</div>
</div>
<div className="mb-4">
<label className="text-sm mb-2" htmlFor="message">Your Message:</label>
<textarea id="message" placeholder="Message" className="p-2 mb-2  rounded-md h-40 w-full bg-[#393E4680] text-[#EEEEEE80]"></textarea>
</div>
